...
def create_all_product():
    ...
    product_1 = Product(name='The Chronicles of Narnia', author='C. S. Lewis', price='150',
    ...
    product_2 = Product(name='Pride and Prejudice', author='Jane Austen', price='90',
    ...
    product_3 = Product(name='Start with Why: How Great Leaders Inspire Everyone to Take Action', author='Simon Sinek', price='120',
    ...
    product_4 = Product(name='Elon Musk: Tesla, SpaceX, and the Quest for a Fantastic Future', author='Ashlee Vance', price='290',
    ...
    product_5 = Product(name='Steve Jobs', author='Walter Isaacson', price='450',
    ...
    product_6 = Product(name='The Art of War', author='Sun Tzu', price='150',
    ...
    product_7 = Product(name='Symposium', author='Plato', price='130',
    ...
    product_8 = Product(name='Discourses and Selected Writings', author='Epictetus', price='100',
